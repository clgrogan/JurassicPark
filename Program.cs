...
namespace JurassicPark
{
  class Program
  {
    ...
    static void DeleteDino(List<Dinosaur> dinos)
    ...
    // will delete all dinosaurs of that name.
    {
      ...
      var dinoName = Console.ReadLine();
      dinos.RemoveAll(r => r.Name.ToLower() == dinoName.ToLower());
      Console.WriteLine();
